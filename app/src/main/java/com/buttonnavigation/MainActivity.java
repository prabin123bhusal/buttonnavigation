...
import com.buttonnavigation.models.LocalUser;
import com.buttonnavigation.models.User;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (localUserList.size() == 0) {
            localUser.setName("robin");
            localUser.setAge("35");
            localUser.setAddress("birgunj");
            ...
            LocalUser localUser2 = new LocalUser();
            localUser2.setName("santoshi");
            localUser2.setAge("55");
            localUser2.setAddress("sindhuli");
            localUser2.setGender("Female");
            localUserList.add(localUser2);
            localUser2.setUserList(localUserList);
        }
        ;
        user.setUsername("prabin");
        user.setPassword("170086");
        users.add(user);
